...
class UserControllerTest extends TestCase
{
    ...
    public function testAssignRole()
    {
        ...
        // $editor = Role::create(['name' => 'editor', 'active' => 1]);
        $res = $this->call('POST', '/users/1/roles', [
            'roleIdOrName'      => 'editor',
        ]);
        $this->assertEquals(204, $res->getStatusCode());
        ...
        $superEditor = factory(Role::class)->create(['name' => 'super editor', 'active' => 1]);
        $res = $this->call('POST', '/users/1/roles', [
   ...
   public function testGetRoles()
    {
        ...
        // test has role
        $editor = factory(Role::class)->create(['name' => 'editor1', 'active' => 1]);
        $editor = factory(Role::class)->create(['name' => 'editor2', 'active' => 1]);
        $editor = factory(Role::class)->create(['name' => 'editor3', 'active' => 1]);
        $res = $this->call('POST', '/users/1/roles', [
        ...
        $res = $this->call('GET', '/users/1/roles?sort=id&direction=desc&page=2', []);
        $this->assertEquals(200, $res->getStatusCode());
        $results = json_decode($res->getContent());
        $this->assertEquals(0, count($results->entities));
